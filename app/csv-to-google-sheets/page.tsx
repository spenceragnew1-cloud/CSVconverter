...
export const metadata: Metadata = {
  title: "CSV to Google Sheets Converter – Coming Soon",
  description:
    "Import CSV files directly into Google Sheets. Coming soon. Try our CSV to Excel converter in the meantime.",
  openGraph: {
    title: "CSV to Google Sheets Converter – Coming Soon",
    description:
      "Import CSV files directly into Google Sheets. Coming soon. Try our CSV to Excel converter in the meantime.",
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12">
      <div className="container mx-auto px-4 max-w-3xl text-center">
        ...
        <p className="text-xl text-gray-700 mb-8">
          Import your CSV files directly into Google Sheets for collaboration
          and analysis.
        </p>
